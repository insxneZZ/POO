...
import org.upm.poo.domain.ItemProduct;
import org.upm.poo.domain.Product;
import org.upm.poo.domain.Ticket;
import org.upm.poo.domain.LineItem;
...
public class TicketPrinter {
    ...
    public static void printState(Ticket t) {
        printHeader(t);
        printTotals(t);
    }

    private static void printHeader(Ticket t) {
        System.out.println("Ticket : " + t.getId());
    }

    private static void printTotals(Ticket t) {
    ...
    public static void printLineItem(Ticket t, LineItem li) {
